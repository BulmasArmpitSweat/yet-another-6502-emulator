...
static inline void _6502_start_cpu(cpu* main) {
...
static inline void _6502_calculate_nanoseconds_per_cycle(cpu *main) {
    char hertz[20];
    char hertz_level;
...
static inline void _6502_mount_external_file(cpu* main) {
    char file_path[101];
    int file_size;
    printf("File to read: ");
