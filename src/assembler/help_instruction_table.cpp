...
#include "help_defs.cpp"

static help_message instructions[] = {
    { "LAS",
    ...
    { "NOP",
        ...
        "The name says it all. This command does nothing but waste time for 2 instructions \n\
        (or more, if an undocumented version is used). Can be used to align commands\n\
